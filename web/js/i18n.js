...
export const STRINGS = {
    en: {
        ...
        'setup.device.apple.wifi': 'Sync over WiFi (enable Sync Server in app Settings)',
        ...
        'settings.handedness.right': '🏌️ Right-handed',
        'settings.handedness.left': '🏌️ Left-handed',
    ...
    ko: {
        ...
        'setup.device.apple.wifi': 'WiFi로 동기화 (앱 설정에서 동기화 서버 활성화 필요)',
        ...
        'settings.handedness': '타격 방향',
        'settings.handedness.right': '🏌️ 오른손잡이',
        'settings.handedness.left': '🏌️ 왼손잡이',
